...
export default function AdminSidebar() {
  ...
  return (
    <div className="h-full basis-[15.5%] flex flex-col px-4 py-5 gap-y-3 border-r border-r-[#E6E6E6] bg-white">
      <div className="flex justify-between">
        <img className="h-[45px] w-fit" src={logo} alt="logo" />
        <img
          className="w-fit h-[25px] cursor-pointer"
          src={SideBarRight}
          alt="logo"
        />
      </div>
      ...
      <div className="flex flex-col gap-y-2 flex-1 w-full mt-7">
        ...
        >
          <PiScroll size={18} className="transition-none flex-shrink-0" />
        ...
        >
          <RiAuctionLine size={18} className="transition-none flex-shrink-0" />
          <span className="line-clamp-1">Auctions</span>
        </NavLink>
        ...
        >
          <TbTie size={16} className="transition-none flex-shrink-0" />
          <span className="line-clamp-1">Field Agents</span>
        </NavLink>
        ...
        >
          <TiFolderOpen size={16} className="transition-none flex-shrink-0" />
