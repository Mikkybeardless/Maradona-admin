          ...
          <div className="w-full md:w-[60%] flex flex-col rounded-2xl bg-white border border-primaryBorder">
            ...
            <div className="px-6 pb-4 flex flex-col text-sm">
              ...
              <div className="flex flex-col gap-y-3 p-3 rounded-lg text-sm border border-primaryBorder bg-black/[2%]">
                ...
                <p className="">
                  "Rosemary has been an exemplary field agent, consistently
                  delivering thorough and accurate verifications. His attention
                  to detail and prompt communication with both sellers and the
                  admin team has significantly improved the quality of our
