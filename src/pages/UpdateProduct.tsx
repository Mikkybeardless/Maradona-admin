...
export default function EditProduct() {
  ...
  const handleSubmit = async () => {
    ...
    //       // single URL string, skip
    //       continue;
    //     }

    //     if (Array.isArray(value)) {
    //       // If array contains strings (URLs), skip
    //       if (value.every((v) => typeof v === "string")) {
    //         continue;
    //       }
    //       // If array contains File objects, append
          ...
          <section className=" w-full md:w-[70%] flex flex-col gap-y-5 overflow-hidden">
            ...
            <div className="w-full rounded-lg p-5 flex flex-col gap-y-3 bg-white border border-primaryBorder">
              ...
              <FileUpload
                ...
                files={productDetails.media as File[]}
                setFiles={(newFiles) => {
                  setProductDetails((prev) => ({
                    ...prev,
                    media:
                      typeof newFiles === "function"
                        ? newFiles(prev.media as File[])
                        : newFiles,
                  }));
                }}
              />
                    ...
                    <div>
                      <div className="w-full px-4 py-2">
                        <FileUpload
                          ...
                          files={productDetails.documents as File[]}
                          setFiles={(newFiles) => {
                            setProductDetails((prev) => ({
                              ...prev,
                              documents:
                                typeof newFiles === "function"
                                  ? newFiles(prev.documents as File[])
                                  : newFiles,
                            }));
                          }}
                        />
